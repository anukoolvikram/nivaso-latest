...
const Testimonials = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full max-w-3xl mx-auto mt-12 p-4 bg-gradient-to-b from-transparent to-gray-500 rounded-xl shadow-lg">
      <div className="overflow-hidden w-full h-30 relative">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="mt-4 text-sm font-semibold bg-white p-2 text-gray-800 rounded-2xl">{testimonials[index].author}</p>
          </motion.div>
        </AnimatePresence>
      </div>
    </div>
