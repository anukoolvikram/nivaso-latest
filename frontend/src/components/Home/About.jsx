...
const About = () => (
  <div className="relative bg-hero min-h-screen overflow-x-hidden">
    ...
    <div className="relative z-10 flex flex-col sm:flex-row h-full font-cormorant">
...
const SecondCard = () => {
  return (
    <div className='h-full px-20 sm:px-30 py-20 text-center text-white flex flex-col justify-around items-center gap-10'>
      <div className='font-barlow text-lg border-2 border-gray-400 p-10'>
